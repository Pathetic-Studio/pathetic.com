// components/header/desktop-nav-social-anim.tsx
"use client";
...
export type DesktopNavSocialAnimHandle = {
  open: () => Promise<void>;
  close: () => Promise<void>;
...
const DesktopNavSocialAnim = forwardRef<DesktopNavSocialAnimHandle, Props>(
  function DesktopNavSocialAnim(
    ...
    const getItems = () => {
      ...
      const items = gsap.utils.toArray<HTMLElement>(
        root.querySelectorAll("[data-social-nav-item]")
      );
      return { root, items };
    };
...
export default DesktopNavSocialAnim;
